...
if option == 'Clubs participants data':
...
elif option == 'Fest participants data':
    ...
    "participants in club events"
    # source = pd.DataFrame({
    #     'No of students': [134, 136, 67],
    #     'Events': ['Event1','Event2','Event3'],
    #  })
    source = pd.DataFrame({
        'No of students': [134, 136, 67, 138, 138, 64, 138, 136, 66],
        'Events': ['Event1','Event2','Event3', 'Event1','Event2','Event3', 'Event1','Event2','Event3'],
        'Club': ['Club1','Club1','Club1', 'Club2','Club2','Club2', 'Club3','Club3','Club3']
     })
